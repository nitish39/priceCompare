...
public class MainController {
	...
	public String firstHomeView(Model m, Principal principal) {
		...
		m.addAttribute("title", "CompareAdda | Price Compare Website!");
	...
	public String registerPage(Model m) {
		...
		m.addAttribute("title", "Register | CompareAdda");
	...
	public String loginPage(Model m) {
		...
		m.addAttribute("title", "Login | CompareAdda");
		return "login";
	}
	...
	public String unbanRequestView(Model m) {
		m.addAttribute("title", "Unban Request | CompareAdda");
	...
	*/
	...
	public String showProfile(Model m, Principal principal, HttpSession httpSession) {
		...
		m.addAttribute("title", user.getName() + " | CompareAdda");
		m.addAttribute("user", user);
		return "profile";
	}
